...
set_partition_info -name "/BaseDesign" -timestamp "1768776480"
set_partition_info -name "/BaseDesign/BaseDesign" -timestamp "1768398334"
set_partition_info -name "/BaseDesign/BaseDesign" -timestamp "1768573952"
set_partition_info -name "/BaseDesign/BaseDesign" -timestamp "1768573952"
set_compile_info \
...
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"C:\polarfire-soc-discovery-kit-reference-design_REPO_N2\MPFS_DISCOVERY_MIV_RV32_CFG1\synthesis\BaseDesign.vm"}
set_compile_info \
    -category {"Options"} \
...
compile \
    ...
    -die PA5SOC095T \
    -pkg fcsg325 \
    -partition_pdc_file {C:\polarfire-soc-discovery-kit-reference-design_REPO_N2\MPFS_DISCOVERY_MIV_RV32_CFG1\designer\BaseDesign\BaseDesign.nmatinit.pdc} \
    -merge_pdc 0
